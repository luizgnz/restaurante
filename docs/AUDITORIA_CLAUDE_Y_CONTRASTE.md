...
*Método:* pruebas de carrera con dos clientes concurrentes, más un `fuzz` de secuencias de órdenes/correcciones verificando invariantes (`reservada_real >= 0`, total vigente = suma del libro).
