...
type Props = {
  ...
  onAceptarSugerencia?: (incidenciaId: number) => Promise<void>;
                      ...
                      <div className={`mesero-incidencia is-${incidencia.tipo}`} key={incidencia.id}>
                        ...
                        <div className="mesero-incidencia__acciones">
                          {incidencia.tipo === "sugerencia" ? (
                            <Button type="button" size="sm" disabled={guardando} onClick={() => aceptar(incidencia.id)}>Sugerencia aceptada</Button>
                          ) : null}
