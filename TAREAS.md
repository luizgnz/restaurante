...
- [ ] Integrar en `feat/nucleo-pos-v1` la cadena #6 → #7 → #8 → #9 → #10 → #11 → #12: cadena corregida, propagada y revisada hasta #12; solo faltan la aprobación formal de otra cuenta de GitHub y la autorización explícita del usuario para el bloque M. Seguir `docs/PLAN_MERGE_PRS_6_12.md` y conservar `prototype/ui-responsive` como referencia del PR original.
