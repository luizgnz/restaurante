...
- [ ] Integrar en `feat/nucleo-pos-v1` la cadena #6 → #7 → #8 → #9 → #10 → #11 → #12 tras las revisiones correspondientes. Todos parten en borrador; seguir la guía de integración y conservar `prototype/ui-responsive` como referencia del PR original.
