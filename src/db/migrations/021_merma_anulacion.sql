-- La merma automática por anulación de un plato ya preparado necesita su propio
-- motivo: no es una pérdida que alguien registró a mano, es la salida real de
-- los insumos que ya se cocinaron. El CHECK anterior solo permitía los dos
-- motivos manuales.
...
CREATE TABLE inventario_movimientos (
  ...
  motivo TEXT CHECK (motivo IS NULL OR motivo IN ('producto_danado', 'consumo_interno', 'anulacion_preparacion')),
